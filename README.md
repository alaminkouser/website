...
```shell
npm --prefix docs install; npm --prefix docs run build; npx --prefix docs @divriots/jampack docs/dist; rm -rf app/home/docs; mv docs/dist/docs app/home/docs; uvicorn app.main:app --reload --port 8080 --host 127.0.0.1 --env-file .env
```
